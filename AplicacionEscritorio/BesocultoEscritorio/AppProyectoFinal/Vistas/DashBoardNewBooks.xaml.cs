...
public partial class DashBoardNewBooks : ContentPage
{
    //Colleccion de datos
    ...
    {
        base.OnAppearing();
        SemanticScreenReader.Default.Announce("Bienvenido a la página principal con un listado de los últimos libros disponibles");
    ...
    private async Task InitializeData()
    {
        ...
        if (App.AuthClient.User != null)
        {
            ...
            newAuthorButton.IsVisible = (user.UserType == "author");
